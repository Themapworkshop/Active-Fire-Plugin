...
class ActiveFire:
    ...
    def MODIS(self):
        ...
        open('MODIS24.zip', 'wb').write(r.content)
        self.iface.addVectorLayer('MODIS24.zip', 'MODIS 24H', 'ogr')
    ...
    def VIIRS(self):
        ...
        open('VIIRS24.zip', 'wb').write(r.content)
        self.iface.addVectorLayer('VIIRS24.zip', 'VIIRS 24H', 'ogr')
        a = self.iface.activeLayer()
        ren = a.renderer()
        sym = QgsMarkerSymbol.createSimple(
        ...
        a.triggerRepaint()  # Refresh Layer
        self.iface.layerTreeView().refreshLayerSymbology(a.id())
        a.setName(a.name().replace(a.name(), 'VIIRS  375 m'))
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.pushButton.clicked.connect(self.MODIS)
            self.dlg.pushButton_2.clicked.connect(self.VIIRS)
